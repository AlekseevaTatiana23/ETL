...
chcp 65001 && spark-shell -i \D:\Data_science\ETL\Hometask1\hw1.scala --conf "spark.driver.extraJavaOptions=-Dfile.encoding=utf-8"
*/
...
if(1==1){
    ...
    .write.format("jdbc").option("url","jdbc:mysql://localhost:5432/spark?user=postgres&password=1994")
